...
<body>
    ...
    <button onclick="window.location='export_excel.php?start=<?= $_GET['start'] ?? '' ?>&end=<?= $_GET['end'] ?? '' ?>'" class="no-print">Export to Excel</button>
        <br><br>
    ...
    <table border="1" cellpadding="10" cellspacing="0" width="40%">
        <tr>
