...
<div class="container my-5 d-flex flex-column row-gap-3">
  ...
  <div class="row align-items-center">
    ...
    <div class="col-sm-6 text-end">
      <a href="./halaman_tambah.php" class="btn btn-success">Tambah Supplier</a>
    </div>
  </div>
  <div class="row">
    <div class="col">
          ...
          <?php else: ?>
            ...
            <?php while ($supplier = mysqli_fetch_assoc($suppliers)): ?>
              <tr>
                ...
                <td>
                  <a href="./halaman_edit.php?id=<?= $supplier["id"] ?>" class="btn btn-warning me-1">Edit</a>
                  <a href="./crud/delete_data.php?id=<?= $supplier["id"] ?>" class="btn btn-danger" onclick="return confirm('Apakah kamu yakin ingin menghapus?')">Hapus</a>
                </td>
              </tr>
            <?php $no++; ?>
            <?php endwhile ?>
